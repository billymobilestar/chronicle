...
export default async function ArtistProfilePage({
  ...
  return (
    <div>
      {/* Banner */}
      <div className="relative h-64 sm:h-80 bg-gradient-cobalt">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative -mt-20 mb-8 flex flex-col sm:flex-row items-start sm:items-end gap-5">
          <div className="relative w-36 h-36 rounded-2xl overflow-hidden border-4 border-white shadow-xl bg-pale-sky flex-shrink-0">
