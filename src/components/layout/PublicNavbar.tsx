              ...
              <div className="relative">
                ...
                {showUserMenu && (
                  <>
                    ...
                    <div className="absolute right-0 top-full mt-2 w-56 bg-white rounded-2xl border-2 border-cobalt/5 shadow-xl z-50 py-2 animate-scale-in">
                      ...
                      >
                        ...
                        {role === "admin" ? "Admin Dashboard" : role === "artist" ? "Artist Dashboard" : "My Feed"}
                      </Link>
          ...
          <div className="md:hidden py-6 border-t-2 border-cobalt/5 animate-fade-in">
            <div className="flex flex-col gap-1">
              ...
              <div className="flex gap-3 mt-6 px-4">
                {user ? (
                  <>
                    <Link href={getDashboardLink()} className="btn-primary text-sm flex-1 text-center !py-3" onClick={() => setMobileOpen(false)}>
                      Dashboard
                    </Link>
                    <button onClick={handleSignOut} className="btn-secondary text-sm flex-1 !py-3">
                      Sign Out
                    </button>
                  </>
                ) : (
                  <>
                    <Link href="/sign-in" className="btn-secondary text-sm flex-1 text-center !py-3">
                      Sign In
                    </Link>
                    <Link href="/sign-up" className="btn-primary text-sm flex-1 text-center !py-3">
                      Join
                    </Link>
                  </>
                )}
